...
local Loader = require('nvim-ssns.ui.panels.object_search.loader')
local Search = require('nvim-ssns.ui.panels.object_search.search')
local Render = require('nvim-ssns.ui.panels.object_search.render')
local Input = require('nvim-ssns.ui.panels.object_search.input')
local Navigation = require('nvim-ssns.ui.panels.object_search.navigation')
  ...
  multi_panel:setup_inputs("settings", settings_cb, {
    on_dropdown_change = function(key, value)
      if key == "server" then
        ...
        if not server then
          local Conns = require('nvim-ssns.connections')
