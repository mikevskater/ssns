...
local QueryProcedures = require('nvim-ssns.ui.core.query.procedures')
local QueryResults = require('nvim-ssns.ui.core.query.results')
local QueryExecute = require('nvim-ssns.ui.core.query.execute')
...
function UiQuery.focus_query_window()
  local ssns_buffer = require('nvim-ssns.ui.core.buffer')
...
function UiQuery.setup_query_keymaps(bufnr)
  ...
  local keymaps = {
    ...
    { mode = "n", lhs = km.rename_identifier or "<F2>", rhs = function()
      local RenameIdentifier = require('nvim-ssns.features.rename_identifier')
  ...
  local CastCommands = require('nvim-ssns.commands.cast')
