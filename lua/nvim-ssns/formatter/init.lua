...
function Formatter.format(sql, config_override, opts)
  ...
  local config = config_override or require('nvim-ssns.config').get_formatter()
...
function Formatter.get_config()
  return require('nvim-ssns.config').get_formatter()
end
...
function Formatter.run_benchmarks(opts)
  local Benchmark = require('nvim-ssns.formatter.benchmark')
