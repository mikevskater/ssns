...
return {
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT * FROM Employees e JOIN Departments d ON e.DeptID = d.DeptID ORDER BY ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT * FROM Employees e JOIN Departments d ON e.DeptID = d.DeptID ORDER BY d.]],
...
ORDER BY ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT * FROM Employees WHERE DeptID = 1 ORDER BY ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT DepartmentID, ManagerID, COUNT(*) FROM Employees GROUP BY DepartmentID, ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT d.DepartmentName, COUNT(*) FROM Employees e JOIN Departments d ON e.DeptID = d.DeptID GROUP BY ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT d.DepartmentName, COUNT(*) FROM Employees e JOIN Departments d ON e.DeptID = d.DeptID GROUP BY d.]],
...
GROUP BY ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT DepartmentID, ManagerID, COUNT(*) FROM Employees GROUP BY DepartmentID, ManagerID, ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[SELECT d.DepartmentName, COUNT(*) FROM Employees e JOIN Departments d ON e.DeptID = d.DeptID GROUP BY d.DepartmentName HAVING ]],
    cursor = { line = 0, col = 124 },
    expected = {
      type = "column",
      items = {
        includes = {
...
HAVING ]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[UPDATE e SET e.Salary = d. FROM Employees e JOIN Departments d ON e.DeptID = d.DeptID]],
  ...
  },
  {
    ...
    database = "vim_dadbod_test",
    query = [[INSERT INTO Employees (FirstName, LastName) SELECT  FROM OldEmployees]],
    cursor = { line = 0, col = 51 },
    expected = {
      type = "column",
      items = {
